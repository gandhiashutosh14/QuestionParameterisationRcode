...
# Use Devtools to compress file to a zip file
#if(!require("devtools")) install.packages("devtools")
#devtools::install_github("RevolutionAnalytics/azureml")

# Get workspace id and authorisation from ml studio

#library(AzureML)
#library(devtools)

#wsID="bad426e8754a499f8afbf5e29ee303a0"
#wsAuth="KONy00eF5y9cc08hdO3Z9WHi4WhbTSmWYHl7wiecswGpXLr46fM86"

#wsobj = workspace(wsID, wsAuth)

# create REST API

#testwebservice <- publishWebService(wsobj,fun = mypredict,name = "testwebservice",inputSchema = data) ## is it??
